...
if __name__ == '__main__':
    ...
    print ("Starting task. . .\n")
    p.cmmnd_CartesianPosition([-0.15, -0.514298737049, 0.2, 0.737172186375, 0.675470352173, 0.00620089983568, 0.0166901424527],0)
    p.cmmnd_CartesianPosition([0,0,-0.27,0,0,0,1],'-r')
    # p.cmmnd_FingerPosition([100,0,0])
    p.cmmnd_FingerPosition([100,100,100])

    ## lift the hammer
    p.cmmnd_CartesianPosition([0,0,0.2,0,0,0,1],'-r')

    ## goto nailing position
    p.cmmnd_CartesianPosition([0.383021354675, -0.472011119127, 0.225680813193, 0.215254470706, 0.730853021145, -0.626273214817, -0.165231049061],0)
