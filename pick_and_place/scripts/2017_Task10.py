...
if __name__ == '__main__':
    ...
    print ("Starting task. . .\n")
    p.cmmnd_CartesianPosition([ 0.500725805759, -0.262309163809, 0.0519425980747, 0.778793990612, 0.626602470875, -0.0130665386096, 0.0260472036898],0)
    p.cmmnd_CartesianPosition([0,0,-0.09,0,0,0,1], '-r')
    # p.cmmnd_FingerPosition([100,100,0])
    # p.cmmnd_CartesianPosition([0,0,-0.02,0,0,0,1], '-r')
    p.cmmnd_JointAngles([0,0,0,0,0,90,0],'0')
